...
const createCustomShadow = (color: string) => {
  ...
  return {
    z1: `0 1px 2px 0 ${transparent1}`,
    z8: `0 8px 16px 0 ${transparent1}`,
    z12: `0 0 2px 0 ${transparent1}, 0 12px 24px 0 ${transparent2}`,
    z16: `0 0 2px 0 ${transparent1}, 0 16px 32px -4px ${transparent2}`,
    z20: `0 0 2px 0 ${transparent1}, 0 20px 40px -4px ${transparent2}`,
    z24: `0 0 4px 0 ${transparent1}, 0 24px 48px 0 ${transparent2}`,
